...
app = ctk.CTk()
app.title(f"Builder by weSteal")
...
def add_icon():
    response = messagebox.askquestion("Add Icon", "icon?")
    return response == 'yes'
...
label = ctk.CTkLabel(master=app, text="we Steal", text_color=("red"), font=("Helvetica", 26))
